...
Public Class Rpt_LabelBarcode
    ...
    Private Sub XrBarCode1_BeforePrint(sender As Object, e As CancelEventArgs) Handles XrBarCode1.BeforePrint
        Dim generator As BarCodeGeneratorBase = Nothing
        Dim value As String = Convert.ToString(Me.GetCurrentColumnValue("Barcode"))
        If ((Strings.Left(value.ToString, 8) = "000000") Or (value.Length = 8)) Then
